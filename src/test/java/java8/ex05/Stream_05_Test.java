...
public class Stream_05_Test {
    ...
    public void monitor_imperativeSum_vs_iterateSum_vs_parallelIterateSum() {
        Logger.getAnonymousLogger().info("imperativeSum => " + monitor(i -> imperativeSum(i), 10000000) + " ms");
        Logger.getAnonymousLogger().info("iterateSum => " + monitor(i -> iterateSum(i), 10000000) + " ms");
        Logger.getAnonymousLogger().info("parallelIterateSum => " + monitor(i -> parallelIterateSum(i), 10000000) + " ms");
    }
    ...
    public void monitor_imperativeSum_vs_iterateSum_vs_parallelIterateSum_vs_rangeSum_vs_rangeParallelSum() {
        Logger.getAnonymousLogger().info("imperativeSum => " + monitor(i -> imperativeSum(i), 100000000) + " ms");
        Logger.getAnonymousLogger().info("iterateSum => " + monitor(i -> iterateSum(i), 100000000) + " ms");
        Logger.getAnonymousLogger().info("parallelIterateSum => " + monitor(i -> parallelIterateSum(i), 100000000) + " ms");
        Logger.getAnonymousLogger().info("rangeSum => " + monitor(i -> rangeSum(i), 100000000) + " ms");
        Logger.getAnonymousLogger().info("rangeParallelSum => " + monitor(i -> rangeParallelSum(i), 100000000) + " ms");
    }
